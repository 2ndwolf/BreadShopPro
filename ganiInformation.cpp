...
namespace GaniBuilding {
	...
	AniFrame::AniFrame() = default;

	AttachedSprite::AttachedSprite() = default;
	...
	GaniInformation::GaniInformation() = default;
