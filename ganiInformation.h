...
namespace GaniBuilding {
    ...
    public:
        ...
        Sound(string &pFileName, double pX, double pY) : fileName(pFileName), x(static_cast<int>(pX * 16)),
    ...
    public:
        ...
        AniSprite(int pSpriteIndex, int pX, int pY, int pLayer) : spriteIndex(pSpriteIndex), x(pX), y(pY),
                                                                  layer(pLayer) {};
    ...
    public:
        ...
        AttachedSprite(int pSpriteA, int pSpriteB, int pRelX, int pRelY) : spriteA(pSpriteA), spriteB(pSpriteB),
                                                                           relX(pRelX), relY(pRelY) {};
    };
